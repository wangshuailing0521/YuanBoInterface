...
{
    [Description("员工审核插件")]
    public class EmployeeAudit: AbstractOperationServicePlugIn
    {
        string url = "http://api.kingdee.114study.com/api/king_dee_users";
        string crmId = "";
        ...
        public void Add(StringBuilder sb, DynamicObject billObj)
        {
            ...
            var requestInfo = new
            {
                king_dee_user_no = billObj["Number"].ToString(),
                king_dee_user_name = billObj["Name"].ToString(),
            ...
            if (model["code"] != null)
            {
                ...
                else
                {
                    ...
                    SqlHelper.UpdateEmployee(this.Context, billObj["Id"].ToString(), crmId);
        ...
        public void Edit(StringBuilder sb, DynamicObject billObj)
        {
            ...
            url = $@"http://api.kingdee.114study.com/api/king_dee_users/{number}";
            var requestInfo = new
            {
                king_dee_user_name = billObj["Name"].ToString(),
                create_no = createOrg["Number"].ToString(),
