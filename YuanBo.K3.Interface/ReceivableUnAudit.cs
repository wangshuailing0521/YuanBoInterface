...
{
    [Description("应收单反审核插件")]
    public class ReceivableUnAudit: AbstractOperationServicePlugIn
    {
        ...
        public void UnAudit(StringBuilder sb, DynamicObject billObj)
        {
