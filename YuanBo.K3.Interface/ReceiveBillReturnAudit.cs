...
{
    [Description("收款退款状态更新插件")]
    public class ReceiveBillReturnAudit: AbstractOperationServicePlugIn
    {
        ...
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            foreach (DynamicObject billObj in e.DataEntitys)
            {
                ...
                sb.AppendLine($@"接口名称：收款退款状态更新API");
        ...
        public void Audit(StringBuilder sb, DynamicObject billObj)
        {
            ...
            if (dept == null)
            {
                dept = billObj["FDepartment"] as DynamicObject;
            }
            ...
            if (string.IsNullOrWhiteSpace(interfaceUrl.ReceBillRStatusUrl))
            {
            ...
            string documentStatus
                = SqlHelper.GetReceBillReturnStatus(this.Context, fid);
            ...
            string url = $@"{interfaceUrl.ReceBillRStatusUrl}";
